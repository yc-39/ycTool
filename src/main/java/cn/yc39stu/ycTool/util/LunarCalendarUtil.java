...
public class LunarCalendarUtil {
	...
	public static void main(String[] args) {
		int solar[] = LunarCalendarUtil.lunarToSolar(1992, 8, 12, false);
		System.out.println(solar[0] + "年" + solar[1] + "月" + solar[2] + "日");
		
		int lunar[] = LunarCalendarUtil.solarToLunar(1992, 9, 8);
		if(lunar[3] == 0)System.out.println(lunar[0] + "年" + lunar[1] + "月" + lunar[2] + "日");//不是闰月
		else             System.out.println(lunar[0] + "年润" + lunar[1] + "月" + lunar[2] + "日"); //是润月
	}
